...
class HsConfig():
    ...
    IMAGES_PER_GPU = 3
    '''HS: 
    orig was 2, 3 works too, but  16,12, or 8, or 4 did not work for ResNet50. 
    even with TRAIN_ROIS_PER_IMAGE 16 doenst work either.
    '''
    ...
    WEIGHT_DECAY = 0.002 # -- 2: 0.0007 -- orig 0.0001.
    ...
    STEPS_PER_EPOCH = None#2: 1000 didnt do anything -- #orig None
    ...
    NAME = "hsConfig"
    RESNET_ARCHITECTURE = "resnet50"  # original was "resnet50" i tried "resnet101" works with batchsize = 2.
